 ...
 */
public class NoScrollListView extends ListView implements AbsListView.OnScrollListener, View.OnTouchListener {


    private static final String TAG = "NoScrollListViewQQ";
